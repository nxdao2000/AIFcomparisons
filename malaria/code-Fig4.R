##
##  R code to generate Figure 4 of
...
s4<-log(MLE-res4)
k4<- density(s4, bw=0.5)
L4<- MLE-exp(k4$x)
lines(L4,k4$y/exp(k4$x), main="",lty=6, col=6, lwd=2,axes=T,xlab='',ylab='', ylim=c(0,0.03), xlim=c(-2200,-1700))
