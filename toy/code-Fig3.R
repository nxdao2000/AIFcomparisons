##
##  R code to generate Figure 3 of
...
binary.file <- "ou2toy10000.rda"
if (file.exists(binary.file)) {
  load(binary.file)
} else {
  CORES <- 60     ## number of parallel processes
  ...
  save(m1.out,etime1,
       ...
       m3.out,etime3,
       m4.out,etime4,
       file="ou2toy10000.rda",compress='xz')
}

load("ou2toy10000.rda")
set.seed(577639485L)
